...
with col1:
    ...
    context_list = orchestrator.get_context_list()
    ...
    with st.expander("See context which will be in {context}"):
        context_for_lab = orchestrator.get_context(selected_context)
...
with col3:
    ...
    if process_button:
        with st.spinner("Running..."):
            response_content = orchestrator.get_text_response(model_id=selected_model, temperature=0.0, template=prompt_text, context=context_text)
